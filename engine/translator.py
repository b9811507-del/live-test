...
T = {
    ...
    "paid_teaser": "Touch and join — see all batches, pay by Razorpay, get your instant join link.",
    ...
    "rf_caption": ("📗 <b>%(label)s</b> · Pages %(pages)s · %(n)s Q · daily test %(date)s — "
