...
def main():
    ...
    o += [block("1) Announce (pinned, 2 min before start)", engine.announce_text("malwa", day, m)),
    ...
    o += [block("1) Announce (pinned)", engine.announce_text("iari", day, i)),
    ...
    o.append("## E. ADMIN DMs (private, English)")
